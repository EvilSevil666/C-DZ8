...
Console.Clear();
Console.WriteLine("Программа которая, задаёт прямоугольный двумерный массив и находит в нём строку с наименьшей суммой элементов."); 
...
void FillArrayRandom(int[,] array)  //Функция заполнения массива рандомно числами от 1 до 9
{
    for (int i = 0; i < array.GetLength(0); i++)
    {
        for (int j = 0; j < array.GetLength(1); j++)
